...
import { ArrowLeft, PenTool, ZoomIn, ZoomOut, X } from "lucide-react";
...
export default function StationeryPage() {
  ...
  return (
    <section className="relative py-20 px-6 md:px-12 lg:px-20 overflow-hidden min-h-screen bg-[#fdfaf6]">
      ...
      >
        <PenTool className="text-[#4caf50]" size={40} />
        Premium Customized Stationery
      </motion.h1>
      ...
      >
        Our <span className="font-semibold text-[#4caf50]">Stationery</span>{" "}
        collection includes everything your brand needs to maintain a
        consistent, professional identity — from notepads, envelopes, and
        folders to visiting cards, pens, and corporate sets. We focus on premium
        printing quality, precision finishing, and elegant customization to
        reflect your brand’s excellence in every detail.
      </motion.p>
      ...
      >
        ...
        <ul className="grid md:grid-cols-2 gap-4 text-gray-700 text-base">
          <li>
            ...
            Notepads, Envelopes, Folders, Visiting Cards, Pens, Stickers,
            Diaries
          </li>
          <li>
            <span className="font-semibold text-[#4caf50]">Material:</span>{" "}
            Premium Paper / Cardstock / PVC / Metal (for pens)
          </li>
          <li>
          ...
          <li>
            ...
            Digital / Offset / UV / Screen Printing
          </li>
          <li>
            <span className="font-semibold text-[#4caf50]">Finishing:</span>{" "}
            Matte / Gloss / Foil Stamping / Emboss / Spot UV
          </li>
          <li>
            <span className="font-semibold text-[#4caf50]">Customization:</span>{" "}
            Logos, Themes, Colors, Packaging, and Corporate Branding
          </li>
          <li>
            <span className="font-semibold text-[#4caf50]">Usage:</span>{" "}
            Offices, Events, Branding Kits, Gifting, Corporate Promotion
          </li>
          <li>
